    ...
    <main class="main">
        <div class="page-head fade-up">
            <div>
                ...
                <p class="page-head__sub">Update your administrator password to keep your account secure.</p>
            </div>
        </div>
        ...
        <div class="grid grid--2 stagger">
            ...
            <div class="card card--dark">
                <span class="eyebrow" style="color:var(--gold-400);">Admin Security</span>
                <h3 class="card__title" style="margin:6px 0 18px;">Best Practices</h3>
                <div style="display:grid;gap:16px;">
                    <div class="flex gap-3" style="align-items:flex-start;">
                        <div style="width:32px;height:32px;border-radius:8px;background:rgba(212,175,55,0.15);display:grid;place-items:center;flex-shrink:0;"><span style="color:var(--gold-400);font-weight:700;">1</span></div>
                        <div><h4 style="color:#fff;font-family:'Inter',sans-serif;font-size:14px;margin-bottom:4px;">Rotate regularly</h4><p style="color:rgba(255,255,255,0.6);font-size:13px;">Change your password every 90 days.</p></div>
                    </div>
                    <div class="flex gap-3" style="align-items:flex-start;">
                        <div style="width:32px;height:32px;border-radius:8px;background:rgba(212,175,55,0.15);display:grid;place-items:center;flex-shrink:0;"><span style="color:var(--gold-400);font-weight:700;">2</span></div>
                        <div><h4 style="color:#fff;font-family:'Inter',sans-serif;font-size:14px;margin-bottom:4px;">Use a password manager</h4><p style="color:rgba(255,255,255,0.6);font-size:13px;">Never store passwords in plain text.</p></div>
                    </div>
                    <div class="flex gap-3" style="align-items:flex-start;">
                        <div style="width:32px;height:32px;border-radius:8px;background:rgba(212,175,55,0.15);display:grid;place-items:center;flex-shrink:0;"><span style="color:var(--gold-400);font-weight:700;">3</span></div>
                        <div><h4 style="color:#fff;font-family:'Inter',sans-serif;font-size:14px;margin-bottom:4px;">Enable 2FA</h4><p style="color:rgba(255,255,255,0.6);font-size:13px;">Add an extra layer of protection.</p></div>
                    </div>
                </div>
            </div>
        </div>
