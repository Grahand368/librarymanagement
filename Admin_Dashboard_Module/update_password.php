...
<body class="app-bg" onload="Aurora.toast('<?php echo $success ? 'Password updated successfully' : 'Wrong current password'; ?>','<?php echo $success ? 'success' : 'error'; ?>'); setTimeout(()=>{window.location.href='<?php echo $success ? 'admin_dashboard.php' : 'change_password.php'; ?>';}, 1400);">
