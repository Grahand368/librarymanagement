...
<head>
    ...
    <title>Members · Aurora Library</title>
    ...
    <main class="main">
        <div class="page-head fade-up">
            <div>
                ...
                <h1 class="page-head__title">Registered <em>Members</em></h1>
                <p class="page-head__sub">All members registered with Aurora Library.</p>
            </div>
            <div class="page-head__actions">
                <input type="search" class="input" placeholder="Search members…" data-table-filter="#membersTable" style="width:240px;padding:10px 14px;">
            </div>
        </div>
                ...
                <?php
                    ...
                    if(mysqli_num_rows($query_run) > 0){
                            ...
                            echo '<tr>
                                <td>
                                    <div class="flex gap-3" style="align-items:center;">
                                        <div class="avatar" style="width:36px;height:36px;font-size:13px;">'.strtoupper(substr($name, 0, 1)).'</div>
                                        <div>
                                            <div class="table__title">'.htmlspecialchars($name).'</div>
                                            <div class="table__sub">Member</div>
                                        </div>
                                    </div>
                                </td>
                                <td>'.htmlspecialchars($email).'</td>
                                <td><span class="mono" style="color:var(--ink-500);">'.htmlspecialchars($mobile).'</span></td>
                        ...
                        echo '<tr><td colspan="4" style="text-align:center;padding:60px 20px;">
                            ...
                            <p style="color:var(--ink-500);">No members registered yet.</p>
                        </td></tr>';
                    }
                ?>
                </tbody>
