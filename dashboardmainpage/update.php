...
<body class="app-bg" onload="Aurora.toast('Profile updated successfully','success'); setTimeout(()=>{window.location.href='user-dashboard.php';}, 1200);">
<div class="auth__panel" style="min-height:100vh;display:flex;align-items:center;justify-content:center;">
    <div class="auth__card fade-up text-center" style="max-width:460px;">
        ...
        <p class="text-sm text-muted">Redirecting to your dashboard…</p>
    </div>
</div>
