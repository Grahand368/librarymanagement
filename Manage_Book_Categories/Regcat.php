...
<head>
    ...
    <title>Categories · Aurora Library</title>
    ...
    <main class="main">
        <div class="page-head fade-up">
            <div>
                ...
                <h1 class="page-head__title">All <em>Categories</em></h1>
                <p class="page-head__sub">Browse all book categories in the library.</p>
            </div>
                ...
                <?php
                    ...
                    if(mysqli_num_rows($query_run) > 0){
                        ...
                        echo '<tr><td style="text-align:center;padding:60px 20px;">
                            ...
                            <p style="color:var(--ink-500);">No categories yet.</p>
                        </td></tr>';
                    }
                ?>
                </tbody>
